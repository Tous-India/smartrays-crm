 ...
 *   much don't. Plus the white-shadow logo variant instead of color (see
 *   BrandLogo.jsx) since the color mark's dark strokes don't hold up
 *   against a busy/varied-brightness photo the way they do against a flat
 *   navy gradient. See frontend/README.md's Login background section for
 *   the full reasoning (which photo, why blur was needed on top of the
 *   scrim, overlay tuning).
 */
    ...
    <div className={`relative min-h-screen overflow-hidden ${isPhoto ? "" : "auth-gradient-bg"}`}>
      ...
      <div className="relative z-10 mx-auto flex min-h-screen max-w-7xl flex-col items-center justify-center gap-10 px-6 py-12 lg:flex-row lg:items-center lg:justify-between lg:gap-8 lg:px-16">
        <div className="hidden max-w-md lg:block">
          <BrandLogo className="w-56" variant={isPhoto ? "white" : "color"} />
        ...
        <div className="flex flex-col items-center lg:hidden">
          <BrandLogo className="w-36" variant={isPhoto ? "white" : "color"} />
        </div>
