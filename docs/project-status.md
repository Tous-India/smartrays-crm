...
frontend), Phase 2 (Customers, backend + frontend; Projects/Tasks, backend only), Phase 3 (Attendance, fully
...
- `frontend/` — **Frontend Phase 0 built 2026-07-16** (scaffold + auth flow + routing shell,
  ...
  (`/attendance`, `/leave`, `/payroll`, ...) renders a shared "coming soon" placeholder,
  ...
  changes when it's built. **Customers frontend module built** (see `.context/final-plan.md`
...
Leads and Customers frontend modules are both done; next step is filling in the rest of the
frontend module-by-module (Attendance is a reasonable next candidate — it has the richest
backend, camera/geo capture aside), the PWA service worker + Dashboard polish (Phase 9's
